...
func (o *GetArticlesArticleIDOK) WithPayload(payload models.Articles) *GetArticlesArticleIDOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get articles article Id o k response
func (o *GetArticlesArticleIDOK) SetPayload(payload models.Articles) {
	o.Payload = payload
}
