...
func (o *GetProfilesUsernameOK) WithPayload(payload *models.ProfileFull) *GetProfilesUsernameOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get profiles username o k response
func (o *GetProfilesUsernameOK) SetPayload(payload *models.ProfileFull) {
	o.Payload = payload
}
