...
func (m *FeedUpdate) validateDescription(formats strfmt.Registry) error {
...
func (m *FeedUpdate) validateImageURL(formats strfmt.Registry) error {
...
func (m *FeedUpdate) validateName(formats strfmt.Registry) error {
